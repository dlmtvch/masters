...
class Database:
	...
	def insertStudentInformation(self, studentInformation, listbox):
		connect = sqlite3.connect('students.db')
		cursor = connect.cursor()
		cursor.execute("INSERT INTO students VALUES ('{0}','{1}', '{2}', '{3}')".format(studentInformation.firstName, studentInformation.lastName, studentInformation.group, studentInformation.faculty))
